<template>
  <v-sheet height="100%" class="overflow-auto" style="position: relative">
    <v-list dense class="mb-n3">
      <v-list-item-content>
        <v-list-item-title class="mb-n3">Font Size</v-list-item-title>
        <v-radio-group width="100%">
          <label for="small" class="mb-1">
            <input
              type="radio"
              id="small"
              value="small"
              v-model="CLOCK.settings.font_size"
              @change="CLOCK.ChangeFontSize()"
            />
            Small
          </label>
          <label for="medium" class="mb-1">
            <input
              type="radio"
              id="medium"
              value="medium"
    ...
    <v-list dense class="mb-n3">
      <v-list-item-content>
        ...
        <div>
          <v-radio-group col>
            <v-radio label="DD/MM/YYYY" value="1"></v-radio>
            <v-radio label="MM/DD/YYYY" value="2"></v-radio>
            <v-radio label="YYYY/MM/DD" value="3"></v-radio>
          </v-radio-group>
        </div>
      </v-list-item-content>
    </v-list>
    ...
    <v-list dense class="mb-n3">
      <v-list-item-content>
        ...
        <div>
          <v-radio-group col>
            <v-radio label="24 Hours" value="1"></v-radio>
            <v-radio label="12 Hours" value="2"></v-radio>
          </v-radio-group>
        </div>
      </v-list-item-content>
    </v-list>
          ...
          <v-radio-group col>
            <label for="analog" class="mb-1">
              <input
                ...
                id="analog"
                value="analog"
                v-model="CLOCK.settings.clock_style"
                @change="CLOCK.ChangeClockStyle()"
              />
              Analog
            </label>
            <label for="digital" class="mb-1">
              <input
                type="radio"
                id="digital"
                value="digital"
